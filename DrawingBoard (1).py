...
cv2.setWindowProperty("Media Board", cv2.WND_PROP_FULLSCREEN, cv2.WINDOW_FULLSCREEN)
...
with mp_hands.Hands(
	...
	while cap.isOpened():
		...
		if results.multi_hand_landmarks:
			...
			x, y = int(results.multi_hand_landmarks[0].landmark[0].x*xc)+15, int(results.multi_hand_landmarks[0].landmark[0].y*yc+15)
